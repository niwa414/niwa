...
with a tapered radius profile `r_wall(x1)` and provide auditable leak metrics.
This case is intentionally a short-window stability gate (`tlim=0.25`) to keep
the stair-step EB diagnostic run numerically stable and reproducible.
