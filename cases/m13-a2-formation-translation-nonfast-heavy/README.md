# A2 Non-fast Formation + Translation (Heavy)

This case exercises Hall-MHD formation + translation in a longer non-fast window
intended for higher-fidelity reference runs.
